...
// express(); const port = 3000; app.use(cors()); app.use(express.json());
// app.get("/", (req, res) => {   res.send("Hello BaasddsafasdfdsafsND"); });
...
const uri = "mongodb://myAdmin:123456@localhost:27017";
